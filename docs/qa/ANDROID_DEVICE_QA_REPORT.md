...
- Default time intervals were audited in [`MAINTENANCE_TIME_INTERVAL_AUDIT.md`](../maintenance/MAINTENANCE_TIME_INTERVAL_AUDIT.md).
...
Evidence is stored under [`evidence/device-qa-20260803/`](./evidence/device-qa-20260803/), including:
